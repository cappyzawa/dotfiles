...
if [[ $ZSH_VERSION == ([1-4]*) ]]; then
    ...
    __starship_get_time() {
        STARSHIP_CAPTURED_TIME=$(/Users/cappyzawa/.local/share/aquaproj-aqua/bin/starship time)
    }
else
...
PROMPT='$('/Users/cappyzawa/.local/share/aquaproj-aqua/bin/starship' prompt --terminal-width="$COLUMNS" --keymap="${KEYMAP:-}" --status="${STARSHIP_CMD_STATUS:-}" --pipestatus="${STARSHIP_PIPE_STATUS[*]:-}" --cmd-duration="${STARSHIP_DURATION:-}" --jobs="$STARSHIP_JOBS_COUNT")'
RPROMPT='$('/Users/cappyzawa/.local/share/aquaproj-aqua/bin/starship' prompt --right --terminal-width="$COLUMNS" --keymap="${KEYMAP:-}" --status="${STARSHIP_CMD_STATUS:-}" --pipestatus="${STARSHIP_PIPE_STATUS[*]:-}" --cmd-duration="${STARSHIP_DURATION:-}" --jobs="$STARSHIP_JOBS_COUNT")'
PROMPT2="$(/Users/cappyzawa/.local/share/aquaproj-aqua/bin/starship prompt --continuation)"
